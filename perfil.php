...
require("./utils/perfil.php");
?>

<main class="container">
    <article class="row">
        <section class="col-12 mx-auto bg-light my-5 py-5 rounded border" id="usuario">
            <?php if (isset($usuarioEncontrado) && $usuarioEncontrado) : ?>
                <h3 class="col-12 text-center my-3">Minhas Informações</h3>
                <table class="table mt-5 mb-2 text-center bg-white">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row" class="text-left pl-4"><?= $usuarioEncontrado["id"]; ?></th>
