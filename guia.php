...
<main class="container">
    <article class="row">
        ...
        <section class="col-12 mx-auto bg-light my-5 px-5 pt-5 rounded border">
            ...
            <article class="px-0 mx-0">
                <h3>unsetRegister( "usuarios", ["email","jose@dasilva.com"] )</h3>
                <p><b>Função unsetRegister( ) com identificador inexistente. Deve retornar false.</b></p>
                <?php
                $usuarioExcluidoInexistente = unsetRegister("usuarios", ["email","jose@dasilva.com"] );
                echo "<br/><pre class='bg-dark text-warning rounded px-3 py-4 mb-5'>";
                var_dump($usuarioExcluidoInexistente);
                echo "</pre><br/>";
                ?>
            </article>
        </section>
